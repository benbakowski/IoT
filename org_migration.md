...
Documentation on the [{{site.data.keyword.iot_short_notm}} APIs](/docs/IoT/reference/api.html#api_overview) provides instructions on how to invoke the APIs and their full set of parameters.
